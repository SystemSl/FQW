...
class StereoInference:
    ...
    def run(self, path_L, path_R=None, output_dir="results"):
        ...
        success, fL_t, fR_t = get_stereo_frames()
        if not success: 
        ...
        pbar = tqdm(total=total_frames - 1, desc="Обработка видео", unit="кадр")

        while True:
            success, fL_t1, fR_t1 = get_stereo_frames()
...
if __name__ == "__main__":
    ...
    # Side-by-Side
    inf.run(path_L="video.mp4", output_dir="scene_flow_result")